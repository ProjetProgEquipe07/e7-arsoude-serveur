    ...
    public class RandonneeControllerTests
    {
        ...
        public async Task ControllerGetRandonnees_Good()
        {
            ...
            using (var dbContext = new ApplicationDbContext(options))
            {
                ...
                var randonnees = new List<RandonneeListDTO>
                {
                    ...
                    {
                        id = 1,
                        nom = "Randonn�e Montagne",
                        description = "Une belle randonn�e en montagne.",
                        emplacement = "Alpes",
                    },
                    new RandonneeListDTO
                    {
                        id = 2,
                        nom = "Randonn�e V�lo",
                        description = "Un parcours � v�lo stimulant.",
        ...
        public async Task ServiceCreateRando_Good()
        {
            ...
            using (var dbContext = new ApplicationDbContext(options))
            {
                ...
                Assert.AreEqual(result.nom, "Randonn�e Montagne");
                Assert.AreEqual(result.description, "Une belle randonn�e en montagne.");
            ...
            using (var dbContext = new ApplicationDbContext(options))
            {
                ...
                var randonnees = new List<Randonnee>
                {
                    ...
                    new Randonnee
                    {
                        id = 2,
                        nom = "test V�lo",
                        description = "Un test � v�lo stimulant.",
                        emplacement = "test",
                        etatRandonnee = Randonnee.Etat.Publique,
                        typeRandonnee = Randonnee.Type.V�lo,
                        GPS = new List<GPS>
                        {
            ...
            using (var dbContext = new ApplicationDbContext(options))
            {
                ...
                var randonnees = new List<Randonnee>
                {
                    new Randonnee
                    {
                        ...
                        description = "Une belle randonn�e en montagne.",
                        emplacement = "Alpes",
                        etatRandonnee = Randonnee.Etat.Priv�e,
                        typeRandonnee = Randonnee.Type.Marche,
                        GPS = new List<GPS>
                        {
                            new GPS { id = 1, x = 45.832619, y = 6.864719, depart = true, arrivee = false },
                ...
                //Devrait en recevoir que 3, car l'utilisateur a 1 rando priv�e et il n'y a que 2 rando publique
