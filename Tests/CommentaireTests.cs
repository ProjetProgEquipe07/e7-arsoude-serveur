...
namespace Tests.Controllers.Commentaires
{
    ...
    public class Controllers
    {
        ...
        [ClassInitialize]
        public async static void ClassInitialize(DbContext dbContext)
        {
        ...
        [ClassCleanup]
        public async static void ClassCleanup(DbContext dbContext)
        {
        ...
        public async Task GetCommentaires_Controller_Ok()
        {
            ...
            // Act
            var controller = CommentaireController(commentaireServiceMock);
