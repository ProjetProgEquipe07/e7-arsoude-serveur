        ...
        /* DbContextOptions<ApplicationDbContext> options;
         ...
         public async Task GetNearSearch_Good()
         {
             ...
             using (var dbContext = new ApplicationDbContext(options))
             {
                 ...
                 searchMock.Setup(service => service.GetNearSearch(It.IsAny<string>(), It.IsAny<Utilisateur>(), It.IsAny<string>(), It.IsAny<bool>(), It.IsAny<int>()))
         ...
         public async Task GetNearSearch_TestFilterWalking()
         {
             ...
             using (var dbContext = new ApplicationDbContext(options))
             {
                 ...
                 var actionResult = await searchMock.Object.GetNearSearch("Montagne", utilisateur, "Marche", false, 0);
         ...
         public async Task GetNearSearch_TestFilterBiking()
         {
             ...
             using (var dbContext = new ApplicationDbContext(options))
             {
                 ...
                 var actionResult = await searchMock.Object.GetNearSearch("vélo", utilisateur, "Vélo", false, 0);
                 dbContext.Database.EnsureDeleted();
                 Assert.AreEqual(actionResult.Count(), 1);
             }
         }
         ...
         public async Task GetNearSearch_TestFilterUndefined()
         {
             ...
             using (var dbContext = new ApplicationDbContext(options))
             {
                 ...
                 var actionResult = await searchMock.Object.GetNearSearch("randonnée", utilisateur, "undefined", false, 0);
                 dbContext.Database.EnsureDeleted();
         ...
         public async Task GetNearSearch_TestMethodeGood()
         {
             ...
             using (var dbContext = new ApplicationDbContext(options))
             {
                 ...
                 var actionResult = await searchMock.Object.GetNearSearch("test", utilisateur, "undefined", false, 0);
                 dbContext.Database.EnsureDeleted();
         ...
         public async Task GetNearSearch_TestAll()
         {
             ...
             using (var dbContext = new ApplicationDbContext(options))
             {
                 ...
                 var actionResult = await searchMock.Object.GetNearSearch("", utilisateur, "undefined", false, 0);
                 dbContext.Database.EnsureDeleted();
         ...
         public async Task GetNearSearch_TestOnlyMyRando()
         {
             ...
             using (var dbContext = new ApplicationDbContext(options))
             {
                 ...
                 var actionResult = await searchMock.Object.GetNearSearch("test", utilisateur, "undefined", true, 0);
                 dbContext.Database.EnsureDeleted();
