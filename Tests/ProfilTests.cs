...
namespace Tests.Controllers
{
    ...
    public class ProfilTest
    {
         ...
         *//*
        [TestMethod]
        public async Task EditProfil_Good()
        {
            using (var dbContext = new ApplicationDbContext(options))
            {
                var userTest = new Utilisateur { identityUserId = "11111111-1111-1111-1111-111111111111", codePostal = "12345", courriel = "test@gmail.com", nom = "George", prenom = "Laroche", adresse = "200 test lane", anneeDeNaissance = 2000, moisDeNaissance = 1 };
                dbContext.utilisateurs.Add(userTest);

                var userManagerMock = new Mock<UserManager<IdentityUser>>(dbContext) { CallBase = true };

                var utilisateursServiceMock = new Mock<UtilisateursService>(dbContext, userManagerMock.Object)
                ...
                var userResult = await dbContext.utilisateurs.Where(u => u.courriel == "test@gmail.com").SingleOrDefaultAsync();

                Assert.AreEqual("Georgy", userResult.nom);// IsInstanceOfType(actionResult.Result, typeof(OkObjectResult));
            }
        }*/

        /*
         * 
         * Créer mes propres test methods
         * 
         * 
         * 
         * 
