...
{
    /// <inheritdoc />
    public partial class bruhmoment2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_commentaires_randonnees_randonnéeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_gps_randonnees_randonnéeId",
                        column: x => x.randonnéeId,
                        principalTable: "randonnees",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_images_randonnees_randonnéeId",
                        column: x => x.randonnéeId,
                        principalTable: "randonnees",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "11111111-1111-1111-1111-111111111111", 0, "ac1bfd48-5753-41e0-a0cb-b1d554039e82", "admin@gmail.com", true, false, null, "ADMIN@GMAIL.COM", "ADMIN@GMAIL.COM", "AQAAAAIAAYagAAAAED7+QmjKj71JmrludQuL8v29qL+j+VonF47ZsSb1h6Fe2T+wl3zMUJdkSoFgetYwzw==", null, false, "ca9419ca-b9c2-48a4-8358-614a618d15ba", false, "admin@gmail.com" },
                    { "11111111-1111-1111-1111-111111111112", 0, "746468d2-a077-4f72-9f9c-b45b76533e9f", "user1@hotmail.com", true, false, null, "USER1@HOTMAIL.COM", "USER1@HOTMAIL.COM", "AQAAAAIAAYagAAAAEGMSggHb+LhFDKbY9JIiYLOnVmOp7fgnyQQ7HJmnRYh/4M8b4ieJpNAJ1/X2e3eTTw==", null, false, "07ce17d5-c4bb-4960-a040-c1d80ac559db", false, "user1@hotmail.com" },
                    { "11111111-1111-1111-1111-111111111113", 0, "0c59d585-d803-463b-91d6-59672997ec07", "user2@hotmail.com", true, false, null, "USER2@HOTMAIL.COM", "USER2@HOTMAIL.COM", "AQAAAAIAAYagAAAAED8K27Sn1I42XmKncpXU8mZ1dcEY8BeO3d0cO9rkaKrEl7mssKpFMypTgKlkB+/tMg==", null, false, "f75d8284-37a7-4f5e-82f6-07926776caf7", false, "user2@hotmail.com" }
                });
